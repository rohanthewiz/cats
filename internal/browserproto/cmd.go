...
const (
	...
	CmdTabMoveToWorkspace = app.CmdTabMoveToWorkspace
...
type (
	...
	MoveTabToWorkspaceParams = app.MoveTabToWorkspaceParams
	MoveTabToWorkspaceResult = app.MoveTabToWorkspaceResult
