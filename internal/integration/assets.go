...
// templating): each carries its own "managed by herdr" banner plus
// HERDR_INTEGRATION_ID / HERDR_INTEGRATION_VERSION markers that install and
...
//go:embed assets/pi/herdr-agent-state.ts
var piExtensionAsset string

//go:embed assets/omp/herdr-agent-state.ts
var ompExtensionAsset string

//go:embed assets/claude/herdr-agent-state.sh
var claudeHookAsset string

//go:embed assets/codex/herdr-agent-state.sh
var codexHookAsset string

//go:embed assets/kimi/herdr-agent-state.sh
var kimiHookAsset string

//go:embed assets/copilot/herdr-agent-state.sh
var copilotHookAsset string

//go:embed assets/droid/herdr-agent-state.sh
var droidHookAsset string

//go:embed assets/opencode/herdr-agent-state.js
var opencodePluginAsset string

//go:embed assets/kilo/herdr-agent-state.js
...
//go:embed assets/qodercli/herdr-agent-state.sh
var qodercliHookAsset string

//go:embed assets/cursor/herdr-agent-state.sh
