...
// CATS_INTEGRATION_ID=opencode
// CATS_INTEGRATION_VERSION=5

import net from "node:net";

const SOURCE = "cats:opencode";
...
export const CatsAgentStatePlugin = async () => {
  if (
    process.env.CATS_ENV !== "1" ||
    !process.env.CATS_SOCKET_PATH ||
    !process.env.CATS_PANE_ID
  ) {
    return {};
  }
